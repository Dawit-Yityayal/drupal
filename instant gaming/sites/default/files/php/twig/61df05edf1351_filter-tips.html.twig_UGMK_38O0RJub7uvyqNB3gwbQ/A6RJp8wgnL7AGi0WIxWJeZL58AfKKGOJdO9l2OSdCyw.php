...
class __TwigTemplate_75edec53f72c70ebbe3f88add5afa997cf81f54cdb8515d7d056713ed164b534 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["long"] ?? null)) ? (("filter-" . twig_replace_filter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 45), 45, $this->source), ["/" => "-"]))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/decor_zymphonies_theme/templates/content-edit/filter-tips.html.twig", "C:\\xampp\\htdocs\\instant gaming\\themes\\decor_zymphonies_theme\\templates\\content-edit\\filter-tips.html.twig");
    }
